  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-slate-50 p-3 sm:p-4 flex flex-col gap-3">
      ...
      <input
        ...
        className="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-cyan-400 disabled:cursor-not-allowed disabled:bg-slate-100"
      />
